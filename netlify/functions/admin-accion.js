...
const TABLAS_PERMITIDAS = ['prestadores', 'vecinos', 'resenas', 'pedidos', 'config_app', 'invitaciones', 'familias', 'consultas_acceso', 'novedades', 'push_config', 'dispositivos','cobros'];
